...
WARNING: LadybugDB auto-commits each command. The transaction manager provides connection binding only, not atomic transactions. See <<transactions>> for details.
